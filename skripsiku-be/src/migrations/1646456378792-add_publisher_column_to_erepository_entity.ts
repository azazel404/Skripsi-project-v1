...
export class addPublisherColumnToErepositoryEntity1646456378792 implements MigrationInterface {
    name = 'addPublisherColumnToErepositoryEntity1646456378792'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`erepositories\` ADD \`publisher\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP COLUMN \`publisher\``);
    }
