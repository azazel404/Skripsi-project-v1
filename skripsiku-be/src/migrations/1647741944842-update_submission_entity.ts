...
export class updateSubmissionEntity1647741944842 implements MigrationInterface {
    name = 'updateSubmissionEntity1647741944842'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`submissions\` DROP FOREIGN KEY \`FK_8b44731fd053ed70dab7a0e5b57\``);
        await queryRunner.query(`ALTER TABLE \`submissions\` DROP COLUMN \`start_date\``);
        await queryRunner.query(`ALTER TABLE \`submissions\` DROP COLUMN \`end_date\``);
        await queryRunner.query(`ALTER TABLE \`submissions\` DROP COLUMN \`stage_id\``);
        await queryRunner.query(`ALTER TABLE \`submissions\` ADD \`name\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submissions\` ADD \`stage\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submissions\` ADD \`submission_period_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`submissions\` ADD CONSTRAINT \`FK_8575c46a09a0773bdfadb2e67aa\` FOREIGN KEY (\`submission_period_id\`) REFERENCES \`submission_periods\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_3cf20fa414914ae683ed8bde242\``);
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_62f945a7c2f0cce3459595bd30f\``);
        await queryRunner.query(`ALTER TABLE \`submissions\` DROP FOREIGN KEY \`FK_8575c46a09a0773bdfadb2e67aa\``);
        ...
        await queryRunner.query(`ALTER TABLE \`submissions\` DROP COLUMN \`submission_period_id\``);
        await queryRunner.query(`ALTER TABLE \`submissions\` DROP COLUMN \`stage\``);
        await queryRunner.query(`ALTER TABLE \`submissions\` DROP COLUMN \`name\``);
        await queryRunner.query(`ALTER TABLE \`submissions\` ADD \`stage_id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submissions\` ADD \`end_date\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submissions\` ADD \`start_date\` datetime NOT NULL`);
