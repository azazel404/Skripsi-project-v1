...
export class addedAbstractSubmissionApprovalDetailsEntity1648471108726 implements MigrationInterface {
    name = 'addedAbstractSubmissionApprovalDetailsEntity1648471108726'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`abstract_submission_approval_details\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`status\` int NOT NULL, \`remarks\` varchar(255) NOT NULL, \`lecturer_id\` int NOT NULL, \`abstract_submission_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE \`abstract_submission_approval_details\``);
    }
