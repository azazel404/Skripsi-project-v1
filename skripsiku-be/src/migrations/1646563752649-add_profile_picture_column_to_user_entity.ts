...
export class addProfilePictureColumnToUserEntity1646563752649 implements MigrationInterface {
    name = 'addProfilePictureColumnToUserEntity1646563752649'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`profile_picture\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD UNIQUE INDEX \`IDX_1585c628c43cc50dc1e061dc50\` (\`profile_picture\`)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_1585c628c43cc50dc1e061dc50\` ON \`users\` (\`profile_picture\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_3cf20fa414914ae683ed8bde242\``);
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_62f945a7c2f0cce3459595bd30f\``);
        await queryRunner.query(`DROP INDEX \`REL_1585c628c43cc50dc1e061dc50\` ON \`users\``);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP INDEX \`IDX_1585c628c43cc50dc1e061dc50\``);
