...
export class removedRelationFromAbstractSubmissionToAbstractSubmissionApprovalDetail1648640034031 implements MigrationInterface {
    name = 'removedRelationFromAbstractSubmissionToAbstractSubmissionApprovalDetail1648640034031'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` DROP FOREIGN KEY \`FK_eed2a1dfe10c5a0b2006a0a18d4\``);
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` DROP COLUMN \`abstract_submission_id\``);
        ...
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` CHANGE \`lecturer_id\` \`lecturer_id\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_3cf20fa414914ae683ed8bde242\``);
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_62f945a7c2f0cce3459595bd30f\``);
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` CHANGE \`lecturer_id\` \`lecturer_id\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` ADD \`abstract_submission_id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` ADD CONSTRAINT \`FK_eed2a1dfe10c5a0b2006a0a18d4\` FOREIGN KEY (\`abstract_submission_id\`) REFERENCES \`abstract_submissions\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
