...
export class updatedSubmissionApprovalDetailEntity1650181147199 implements MigrationInterface {
    name = 'updatedSubmissionApprovalDetailEntity1650181147199'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` DROP COLUMN \`score\``);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` ADD \`score_content\` int NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` ADD \`score_content_delivery\` int NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` ADD \`score_content_mastery\` int NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` ADD \`score_average\` int NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` DROP COLUMN \`score_average\``);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` DROP COLUMN \`score_content_mastery\``);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` DROP COLUMN \`score_content_delivery\``);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` DROP COLUMN \`score_content\``);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` ADD \`score\` int NOT NULL`);
    }
