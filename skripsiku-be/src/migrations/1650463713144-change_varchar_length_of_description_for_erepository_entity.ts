...
export class changeVarcharLengthOfDescriptionForErepositoryEntity1650463713144 implements MigrationInterface {
    name = 'changeVarcharLengthOfDescriptionForErepositoryEntity1650463713144'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`erepositories\` ADD \`description\` varchar(65535) NOT NULL`);
