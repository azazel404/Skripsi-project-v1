...
export class setRemarksNullableForSubmissionAttachmentEntity1650183298021 implements MigrationInterface {
    name = 'setRemarksNullableForSubmissionAttachmentEntity1650183298021'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD CONSTRAINT \`FK_99f57fa639a31654936b41af35d\` FOREIGN KEY (\`attachment\`) REFERENCES \`attachments\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`submission_approval_details\` CHANGE \`remarks\` \`remarks\` varchar(255) NOT NULL`);
