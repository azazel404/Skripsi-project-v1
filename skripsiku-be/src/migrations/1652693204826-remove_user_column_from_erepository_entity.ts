...
export class removeUserColumnFromErepositoryEntity1652693204826 implements MigrationInterface {
    name = 'removeUserColumnFromErepositoryEntity1652693204826'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_3cf20fa414914ae683ed8bde242\``);
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP COLUMN \`user\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`erepositories\` ADD \`user\` int NULL DEFAULT 'NULL'`);
