...
export class updateSubmissionAttachmentEntity1647747229698 implements MigrationInterface {
    name = 'updateSubmissionAttachmentEntity1647747229698'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` DROP FOREIGN KEY \`FK_d964e5066c655aec1230990b47a\``);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` CHANGE \`stage_id\` \`stage\` int NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` CHANGE \`stage\` \`stage_id\` int NOT NULL`);
