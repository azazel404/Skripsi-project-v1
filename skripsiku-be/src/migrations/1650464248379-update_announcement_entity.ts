...
export class updateAnnouncementEntity1650464248379 implements MigrationInterface {
    name = 'updateAnnouncementEntity1650464248379'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`announcements\` ADD \`description\` text NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`announcements\` DROP COLUMN \`description\``);
        await queryRunner.query(`ALTER TABLE \`announcements\` ADD \`description\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`announcements\` ADD CONSTRAINT \`FK_441ddc3a9a093b8046bafa3f040\` FOREIGN KEY (\`attachment\`) REFERENCES \`attachments\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
