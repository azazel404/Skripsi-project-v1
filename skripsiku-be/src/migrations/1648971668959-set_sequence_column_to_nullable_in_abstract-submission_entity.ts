...
export class setSequenceColumnToNullableInAbstractSubmissionEntity1648971668959 implements MigrationInterface {
    name = 'setSequenceColumnToNullableInAbstractSubmissionEntity1648971668959'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`abstract_submissions\` CHANGE \`sequence\` \`sequence\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`abstract_submissions\` ADD CONSTRAINT \`FK_e8a0284e69854693ab8f2245470\` FOREIGN KEY (\`attachment\`) REFERENCES \`attachments\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
