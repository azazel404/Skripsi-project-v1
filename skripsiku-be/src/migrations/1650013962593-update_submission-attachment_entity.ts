...
export class updateSubmissionAttachmentEntity1650013962593 implements MigrationInterface {
    name = 'updateSubmissionAttachmentEntity1650013962593'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_99f57fa639a31654936b41af35\` ON \`submission_attachments\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` CHANGE \`location\` \`location\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` CHANGE \`start_time\` \`start_time\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` CHANGE \`date\` \`date\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD CONSTRAINT \`FK_99f57fa639a31654936b41af35d\` FOREIGN KEY (\`attachment\`) REFERENCES \`attachments\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_99f57fa639a31654936b41af35\` ON \`submission_attachments\` (\`attachment\`)`);
    }
