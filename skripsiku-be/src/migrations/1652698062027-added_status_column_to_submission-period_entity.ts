...
export class addedStatusColumnToSubmissionPeriodEntity1652698062027 implements MigrationInterface {
    name = 'addedStatusColumnToSubmissionPeriodEntity1652698062027'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`submission_periods\` ADD \`status\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`erepositories\` CHANGE \`major\` \`major\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP FOREIGN KEY \`FK_36140e591dbea83bac5b2f8fa7d\``);
        await queryRunner.query(`ALTER TABLE \`comments\` DROP FOREIGN KEY \`FK_61b705e97f03cb428ad727922cc\``);
        await queryRunner.query(`ALTER TABLE \`erepositories\` CHANGE \`major\` \`major\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`submission_periods\` DROP COLUMN \`status\``);
    }
