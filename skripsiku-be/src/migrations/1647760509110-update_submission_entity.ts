...
export class updateSubmissionEntity1647760509110 implements MigrationInterface {
    name = 'updateSubmissionEntity1647760509110'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`FK_d964e5066c655aec1230990b47a\` ON \`submission_attachments\``);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` DROP COLUMN \`score\``);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` DROP COLUMN \`submission_id\``);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` DROP COLUMN \`stage_id\``);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` ADD \`stage\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` ADD \`average_score\` int NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` DROP COLUMN \`average_score\``);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` DROP COLUMN \`stage\``);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` ADD \`stage_id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` ADD \`submission_id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_approvals\` ADD \`score\` int NOT NULL`);
        await queryRunner.query(`CREATE INDEX \`FK_d964e5066c655aec1230990b47a\` ON \`submission_attachments\` (\`stage\`)`);
