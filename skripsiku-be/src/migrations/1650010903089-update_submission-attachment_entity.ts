...
export class updateSubmissionAttachmentEntity1650010903089 implements MigrationInterface {
    name = 'updateSubmissionAttachmentEntity1650010903089'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` DROP COLUMN \`attachment_id\``);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD \`date\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD \`start_time\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD \`location\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD \`attachment\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD UNIQUE INDEX \`IDX_99f57fa639a31654936b41af35\` (\`attachment\`)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_99f57fa639a31654936b41af35\` ON \`submission_attachments\` (\`attachment\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_3cf20fa414914ae683ed8bde242\``);
        await queryRunner.query(`ALTER TABLE \`erepositories\` DROP FOREIGN KEY \`FK_62f945a7c2f0cce3459595bd30f\``);
        await queryRunner.query(`DROP INDEX \`REL_99f57fa639a31654936b41af35\` ON \`submission_attachments\``);
        ...
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` DROP INDEX \`IDX_99f57fa639a31654936b41af35\``);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` DROP COLUMN \`attachment\``);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` DROP COLUMN \`location\``);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` DROP COLUMN \`start_time\``);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` DROP COLUMN \`date\``);
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD \`attachment_id\` int NOT NULL`);
    }
