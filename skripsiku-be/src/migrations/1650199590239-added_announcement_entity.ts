...
export class addedAnnouncementEntity1650199590239 implements MigrationInterface {
    name = 'addedAnnouncementEntity1650199590239'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`announcements\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`title\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`document\` int NULL, \`image\` int NULL, UNIQUE INDEX \`REL_a3b441c7569693a3ee9d72fa7b\` (\`document\`), UNIQUE INDEX \`REL_af5515c63ea99a6746624721ee\` (\`image\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
