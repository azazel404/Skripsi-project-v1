...
export class removeIsHeadOfStudyColumnFromLecturerEntity1648822958559 implements MigrationInterface {
    name = 'removeIsHeadOfStudyColumnFromLecturerEntity1648822958559'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`lecturers\` DROP COLUMN \`is_head_of_study\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`lecturers\` ADD \`is_head_of_study\` tinyint NOT NULL`);
    }
