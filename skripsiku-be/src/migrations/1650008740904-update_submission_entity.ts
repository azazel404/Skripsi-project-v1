...
export class updateSubmissionEntity1650008740904 implements MigrationInterface {
    name = 'updateSubmissionEntity1650008740904'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submissions\` ADD \`title\` varchar(255) NOT NULL`);
