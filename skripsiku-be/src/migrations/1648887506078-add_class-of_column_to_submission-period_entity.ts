...
export class addClassOfColumnToSubmissionPeriodEntity1648887506078 implements MigrationInterface {
    name = 'addClassOfColumnToSubmissionPeriodEntity1648887506078'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`submission_periods\` ADD \`class_of\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submission_periods\` DROP COLUMN \`class_of\``);
    }
