...
export class addedEndTimeColumnToSubmissionAttachmentEntity1651311536618 implements MigrationInterface {
    name = 'addedEndTimeColumnToSubmissionAttachmentEntity1651311536618'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` ADD \`end_time\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submission_attachments\` DROP COLUMN \`end_time\``);
    }
