...
export class updateAbstractSubmissionApprovalDetailEntity1650464472221 implements MigrationInterface {
    name = 'updateAbstractSubmissionApprovalDetailEntity1650464472221'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` DROP COLUMN \`remarks\``);
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` ADD \`remarks\` text NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`announcements\` ADD CONSTRAINT \`FK_441ddc3a9a093b8046bafa3f040\` FOREIGN KEY (\`attachment\`) REFERENCES \`attachments\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` DROP COLUMN \`remarks\``);
        await queryRunner.query(`ALTER TABLE \`abstract_submission_approval_details\` ADD \`remarks\` varchar(255) NULL DEFAULT 'NULL'`);
