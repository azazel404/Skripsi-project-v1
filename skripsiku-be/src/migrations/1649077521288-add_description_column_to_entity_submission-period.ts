...
export class addDescriptionColumnToEntitySubmissionPeriod1649077521288 implements MigrationInterface {
    name = 'addDescriptionColumnToEntitySubmissionPeriod1649077521288'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`submission_periods\` ADD \`description\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`submission_periods\` DROP COLUMN \`description\``);
    }
