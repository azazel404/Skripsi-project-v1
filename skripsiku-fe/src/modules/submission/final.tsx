...
const FinalAssessment = (props: any) => {
    ...
    const uploadDocument = (event: any) => {
        ...
        UploadAPI.attachDoc(formData).then(res => {
            ...
            SubmissionAPI.updateFinalByStudent(payload, data.id)
                .then(res => {
            ...
            <Paper elevation={3} sx={{ width: '100%', marginTop: '24px', minHeight: '320px' }}>
                <div style={{ padding: '14px', marginTop: '24px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <Typography style={{ fontSize: '24px', fontWeight: 'bold' }}>Tahap 2 - Ujian Sidang</Typography>
                    ...
                    <div style={{ display: 'flex', marginTop: '24px', marginBottom: '16px', flexDirection: 'column' }}>
                        <div style={{ display: 'flex' }}>
                            <Typography style={{ fontSize: '14px', fontWeight: 'bold' }}>Jadwal Ujian</Typography>
                        </div>
            ...
            <Grid container spacing={2} style={{ marginTop: '8px' }}>
                <Grid item xs={12}>
                    <Card>
                        ...
                        <CardContent sx={{ width: '100%', height: '120px', padding: '14px', overflow: 'auto' }}>
                            {approvers.length > 0 ?
                                <>
