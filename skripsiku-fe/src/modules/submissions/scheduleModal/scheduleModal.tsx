...
const ScheduleSeminarModal = (props: CreateEditModalInterface) => {
    const { open, handleClose, detail, onSubmitModal, type = "seminar", isLoading } = props;
    ...
    const schema = yup.object({
        date: yup.string().required("Tanggal Mulai wajib diisi").nullable(),
        start_time: yup.string().required("Waktu Mulai wajib diisi").nullable(),
        end_time: yup.string().required("Waktu Berakhir wajib diisi").nullable(),
        location: yup.string().required("Lokasi wajib diisi").nullable(),
        penguji1: yup.string().required("Penguji 1 wajib diisi").nullable(),
        penguji2: yup.string().required("Penguji 2 wajib diisi").nullable(),
    ...
    const onSubmit: SubmitHandler<IFormInputs> = (data) => {
        let countPenguji;
        if (data.penguji3) {
            countPenguji = [data.penguji1, data.penguji2, data.penguji3]
        }
        else {
            countPenguji = [data.penguji1, data.penguji2]
        }
        ...
        let payload = {
            ...
            submission_attachment_approver_ids: countPenguji
        }
        ...
        <div>
            ...
            >
                <DialogTitle id="alert-dialog-title">
                    Jadwal {type === "seminar" ? "Seminar" : "Final"} Proposal
                </DialogTitle>
                <DialogContent>
                    <p>Tanggal Mulai</p>
                    <Controller
