...
const DetailAnnouncement = (props: any) => {
    ...
    const retrieveDetail = () => {
        setIsFetching(true);
        AnnouncementAPI.getById(id).then((res: any) => {
            let initial = {
                ...res.data,
    ...
    const onSubmit: SubmitHandler<IFormInputs> = (values) => {
        ...
        AnnouncementAPI.update(id, payload)
            .then((res: any) => {
                ...
                dispatch(openNotificationToast("Berhasil mengubah pengumuman"));
            })
            .catch(err => {
                let error = Helpers.ErrorHandler(err)
                dispatch(openErrorToast(error.message));
        ...
        >
            <Container >
                <Card>
                    ...
                    >
                        <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Ubah Pengumuman</span>
                        <Button
                            color="primary"
                            variant="contained"
                            size="small"
...
DetailAnnouncement.getLayout = (page: any) => <DashboardLayout>{page}</DashboardLayout>;
