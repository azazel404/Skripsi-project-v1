...
const CreateLecturer = (props: any) => {
    ...
    const onSubmit: SubmitHandler<IFormInputs> = (values) => {
        ...
        let payload = {
            ...
            role: values.role,
            is_head_of_study: false
        }

        LecturerAPI.create(payload)
            .then((res: any) => {
                router.push("/lecturer")
                dispatch(openNotificationToast("Berhasil menambahkan dosen"));
            })
            .catch(err => {
        ...
        >
            <Container >
                <Card>
                    ...
                    >
                        <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Tambah Dosen</span>
                        <Button
                            color="primary"
                            variant="contained"
                            size="small"
...
CreateLecturer.getLayout = (page: any) => <DashboardLayout>{page}</DashboardLayout>;
