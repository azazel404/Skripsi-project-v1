...
const CreateAccount = (props: any) => {
    ...
    const onSubmit: SubmitHandler<IFormInputs> = (values) => {
        ...
        UserAPI.createAdminAndDekan(payload)
            .then((res: any) => {
                router.push("/users")
                dispatch(openNotificationToast("Berhasil menambahkan pengguna"));
            })
            .catch(err => {
        ...
        >
            <Container >
                <Card>
                    ...
                    >
                        <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Tambah Pengguna</span>
                        <Button
                            color="primary"
                            variant="contained"
                            size="small"
...
CreateAccount.getLayout = (page: any) => <DashboardLayout>{page}</DashboardLayout>;
