...
const CreateERepository = (props: any) => {
    ...
    const schema = yup.object({
        ...
        keyword: yup.string().required("Keyword wajib diisi"),
        lecturer: yup.string().required("Pembimbing wajib diisi"),
    })
    ...
    const onSubmit: SubmitHandler<IFormInputs> = (values) => {
        ...
        ERepositoryAPI.create(payload)
            .then((res: any) => {
                router.push("/manage-erepository")
                dispatch(openNotificationToast("Berhasil menambahkan e-repository"));
            })
            .catch(err => {
                let error = Helpers.ErrorHandler(err)
                dispatch(openErrorToast(error.message));
        ...
        >
            <Container >
                <Card>
                    ...
                    >
                        <span style={{ fontWeight: 'bold', fontSize: '16px' }}>Tambah E-Repository</span>
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                ...
                                                disabled={isFetching}
                                                variant="outlined"
                                                placeholder="Contoh Keyword : Kompetensi;Teknik;Information"
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                ...
                                                helperText={errors.lecturer ? errors.lecturer?.message : ''}
                                                fullWidth
                                                margin="dense"
                                            />
                                        )}
...
CreateERepository.getLayout = (page: any) => <DashboardLayout>{page}</DashboardLayout>;

export default CreateERepository;