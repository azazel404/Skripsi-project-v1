...
import { Box, Container, Button, Avatar, Typography, Grid, Paper, Card, CardContent, Divider } from "@mui/material";
...
const DetailSubmission = (props: any) => {
    ...
    const retrieveSubmissionApprovalDetail = (id) => {
        setIsLoading(true)
        let payload = {
            isActionTaken: ""
        }
        AbstractSubmissionApprovalAPI.getApproval(parseInt(id), payload).then((res: any) => {
    ...
    const retrieveSubmissionApprovalHistory = (id) => {
        setIsLoading(true)
        let payload = {
            isActionTaken: true
        }
        ...
        if (status === 1) {
            return (
                <div style={{ display: 'flex' }}>
                    <Typography style={{ fontSize: '14px', marginRight: '4px' }}>Status pengajuan proposal judul TA diubah menjadi</Typography>
                    <Typography style={{ fontSize: '14px', fontWeight: 'bold' }} color="primary">DITERIMA.</Typography>
                </div>
            )
        }
        else if (status === 2) {
            return (
                <div style={{ display: 'flex' }}>
                    <Typography style={{ fontSize: '14px', marginRight: '4px' }}>Status diubah menjadi</Typography>
                    <Typography style={{ fontSize: '14px', fontWeight: 'bold', color: '#D14242' }}>DITOLAK.</Typography>
                </div>
            )
        }
    }
    ...
    return (
        <>
            ...
            >
                <Container >
                    <ToolbarComponent title={"Detail Pengajuan Judul T.A"} />
